...
class Config:
    ...
    CERTIFICATE_NAME_DEFAULT_X_MM = float(os.environ.get('CERTIFICATE_NAME_DEFAULT_X_MM', '30'))
    CERTIFICATE_NAME_DEFAULT_Y_MM = float(os.environ.get('CERTIFICATE_NAME_DEFAULT_Y_MM', '65'))
